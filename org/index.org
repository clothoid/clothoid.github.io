...
** 2020    
   ...
   + [[file:2020/install-mecab-on-ubuntu-20.04.1LTS.org][/bin/sh: 1: mecab-config: not found]]
...
** 2019
   ...
   + [[file:2019/org-latex-export-to-pdf.org][emacs の org-latex-export-to-pdf 設定手順]]
...
** 2018
   ...
   + [[file:2018/emacs-google-calendar-org-gcal.org][emacs org-mode と google calendar を連携させる org-gcal]]
   + [[file:2018/emacs-worldcup2018-ical-calendar.org][emacs でワールドカップの日程をサクッと表示する]]
   + [[file:2018/org-latex-pdf-with-minted-python.org][org export で minted ハイライト表示した PDF 一発作成]]
...
** 2016
   ...
   # VERR _ ACCESS _ DENIED for virtualbox
   # 1 環境
   #     Windows 7 64bit
   ...
   # 4 参考
   #     ストレージにホストドライブ(DVD ドライブ)を追加できない | VirtualBox Mania
   #     http://vboxmania.net/node/563
   # + [[file:2016/virtualbox-change-windows-resolution.org][VirtualBox で Windows の解像度を変化させる]]
   # VirtualBox で Windows の解像度を変化させる
   # 1 環境
   #     Windows 7 64bit
   #     Windows 2012 R2 on Oracle VM VirtualBox 5.0.16r105871
   # 2 解像度を動的に変化させる方法
   ...
   #     CD ドライブにマウントされるので、開く
   #     [VboxWindowsAdditons-amd64.exe]を管理者権限で実行
   #     画面に従ってインストール
